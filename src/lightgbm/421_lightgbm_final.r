...
PARAM$finalmodel$num_iterations <- 33 #antes 1000
PARAM$finalmodel$learning_rate <- 0.20553823 #0.027
PARAM$finalmodel$feature_fraction <- 0.699047142 # 0.8
PARAM$finalmodel$min_data_in_leaf <- 76
PARAM$finalmodel$num_leaves <- 2841 # 8
#nuevo parámetros
PARAM$finalmodel$lambda_l1 <- 0.016646627
PARAM$finalmodel$lambda_l2 <- 0.0454159791383812
PARAM$finalmodel$bagging_fraction <- 0.700701547
...
modelo <- lgb.train(
  ...
  param = list(
    ...
    lambda_l1= PARAM$finalmodel$lambda_l1,#nuevo parámetros
...
cortes <- seq(500, 1500, by = 100) #acá cambiar según la meseta de la curva de ganacia
